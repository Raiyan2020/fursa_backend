...
$additionalRoutes = [
    ...
    'item' => [
        ...
        req('Reopen Learn & Serve Registration', 'POST', 'learn-serve-opportunities/{{opportunity_id}}/reopen-registration/', "## Reopen Learn & Serve Registration\nBE-63. Reopen registration for an owned Learn & Serve opportunity. No request body.\n\nRefused with 422 once the toggle window has closed (one day before `end_date`) — mirrors the volunteer reopen-registration guard.", true),
