...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .hours { margin-top: 14px; font-size: 18px; font-weight: 700; color: var(--gold); }
...
<body>
    <div class="sheet" @if ($background_url) style="background-image:url('{{ $background_url }}')" @endif>
        ...
        <div class="kind">{{ $is_arabic_name ? 'شهادة تطوع' : 'Certificate of Volunteering' }}</div>
        ...
        @if ($total_hours !== null)
            <div class="hours">
                {{ $is_arabic_name ? 'إجمالي ساعات التطوع' : 'Total volunteer hours' }}: {{ $total_hours }}
            </div>
        @endif
