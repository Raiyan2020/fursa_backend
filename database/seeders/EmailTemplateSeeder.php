...
HTML;
        ...
        $templates = [
            ...
            ['volunteer_certificate_issued', 'Your certificate is ready: {{opportunity_title_en}}', 'شهادتك جاهزة: {{opportunity_title_ar}}', 'Hi {{first_name}},<br><br>Your certificate for <b>{{opportunity_title_en}}</b> has been issued and is now available in your profile\'s Certificates tab.', 'مرحباً {{first_name}}،<br><br>تم إصدار شهادتك في <b>{{opportunity_title_ar}}</b> وهي متاحة الآن في تبويب الشهادات بملفك الشخصي.'],
            ...
            ['new_opportunity_notification', 'New {{opportunity_type_en}} opportunity: {{opportunity_title_en}}', 'فرصة {{opportunity_type_ar}} جديدة: {{opportunity_title_ar}}', 'A new {{opportunity_type_en}} opportunity matching your age group is now open: {{opportunity_title_en}}. Starts {{start_date}}. Registration closes {{due_date}}.', 'فرصة {{opportunity_type_ar}} جديدة تناسب فئتك العمرية متاحة الآن: {{opportunity_title_ar}}. تبدأ في {{start_date}}. التسجيل يُغلق في {{due_date}}.'],
